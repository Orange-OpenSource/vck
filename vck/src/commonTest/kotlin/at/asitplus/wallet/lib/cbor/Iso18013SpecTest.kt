...
val Iso18013SpecTest by matrixSuite {
    ...
    "mdoc request" {
        ...
        docRequest.itemsRequest.value.docType shouldBe "org.iso.18013.5.1.mDL"
    ...
    "mdoc response" {
        ...
        issuerSignedList.findItem(9U).elementValue.shouldNotBeNull()
    ...
    "IssuerAuth Deserialization" {
        ...
        val coseSigned =
            CoseSigned.deserialize(MobileSecurityObject.serializer(), input.decodeToByteArray(Base16(true)))
                .getOrThrow()
