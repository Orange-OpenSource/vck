...
data class EuPidCredentialSdJwt(
    ...
    @SerialName(EuPidSdJwtDataElements.GIVEN_NAME_BIRTH)
    val givenNameBirth: String? = null,

    /** Place of birth. */
    @SerialName(EuPidSdJwtDataElements.PREFIX_PLACE_OF_BIRTH)
    val placeOfBirth: PlaceOfBirthSdJwt,

    /** Address. */
    @SerialName(EuPidSdJwtDataElements.PREFIX_ADDRESS)
    val address: AddressSdJwt? = null,

    /** See [IsoIec5218Gender]. */
    @SerialName(EuPidSdJwtDataElements.SEX)
    ...
    @SerialName(EuPidSdJwtDataElements.NATIONALITIES)
    ...
    @SerialName(EuPidSdJwtDataElements.ISSUANCE_DATE)
    val issuanceDate: LocalDateOrInstant? = null,

    /** Date (and if possible time) when the person identification data will expire. */
    @SerialName(EuPidSdJwtDataElements.EXPIRY_DATE)
     ...
     */
    @SerialName(EuPidSdJwtDataElements.ISSUING_AUTHORITY)
    val issuingAuthority: String,

    /** A number for the PID, assigned by the PID Provider. */
    @SerialName(EuPidSdJwtDataElements.DOCUMENT_NUMBER)
    val documentNumber: String? = null,

    /** Alpha-2 country code, as defined in ISO 3166-1, of the PID Provider's country or territory. */
    @SerialName(EuPidSdJwtDataElements.ISSUING_COUNTRY)
     ...
     */
    @SerialName(EuPidSdJwtDataElements.ISSUING_JURISDICTION)
     ...
     */
    @SerialName(EuPidSdJwtDataElements.PERSONAL_ADMINISTRATIVE_NUMBER)
    ...
    @SerialName(EuPidSdJwtDataElements.PORTRAIT)
    ...
    @SerialName(EuPidSdJwtDataElements.EMAIL)
    ...
    @SerialName(EuPidSdJwtDataElements.PHONE_NUMBER)
    ...
    @SerialName(EuPidSdJwtDataElements.TRUST_ANCHOR)
...
data class PlaceOfBirthSdJwt(
    ...
    @SerialName(EuPidSdJwtDataElements.PlaceOfBirth.COUNTRY)
    val country: String? = null,

    /** The state, province, district, or local area where the PID User was born. */
    @SerialName(EuPidSdJwtDataElements.PlaceOfBirth.REGION)
    val region: String? = null,

    /** The municipality, city, town, or village where the PID User was born. */
    @SerialName(EuPidSdJwtDataElements.PlaceOfBirth.LOCALITY)
...
data class AddressSdJwt(
     ...
     */
    @SerialName(EuPidSdJwtDataElements.Address.FORMATTED)
