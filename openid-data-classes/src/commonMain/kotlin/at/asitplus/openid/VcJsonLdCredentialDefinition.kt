...
data class VcJsonLdCredentialDefinition(
    /**
     * OID4VCI: @context: REQUIRED. Array as defined in [VC DM 1.1](https://www.w3.org/TR/vc-data-model-1.1/#contexts):
    ...
    /**
     * OID4VCI: type: REQUIRED. Array designating the types a certain credential type supports, according to
     * [VC DM 1.1](https://www.w3.org/TR/vc-data-model-1.1/#types):
     *     The value of the `type` property MUST be, or map to (through interpretation of the `@context` property),
     *     one or more URIs. If more than one URI is provided, the URIs MUST be interpreted as an unordered set.
