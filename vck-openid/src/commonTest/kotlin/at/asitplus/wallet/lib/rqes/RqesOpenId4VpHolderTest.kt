...
val RqesOpenId4VpHolderTest by matrixSuite {
    ...
    fixture {
        object {
            ...
            val baseSignatureProperties = RqesWalletService.SignatureProperties()
        }
    } - {
        ...
        test("CscAuthDetails respects SigningCredential") {
            ...
            val authDetails = it.rqesWalletService.getCscAuthenticationDetails(
        ...
        test("CscDocumentDigest respects SigningCredential") {
            ...
            val validCert = it.dummyValueProvider.getCredentialInfo()
            val testDocumentDigests = it.rqesWalletService.getCscDocumentDigests(
                digests,
        ...
        test("AuthenticationRequest CREDENTIAL") {
            ...
            val request = it.rqesWalletService.createCredentialAuthenticationRequest(
        ...
        test("TokenRequest") {
            ...
            val request = it.rqesWalletService.createOAuth2TokenRequest(
